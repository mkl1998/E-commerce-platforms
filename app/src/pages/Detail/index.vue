          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:value.isChecked==1}" v-for="(value,index) in spuSaleAttr.spuSaleAttrValueList" :key="value.id" @click="changeActive(value,spuSaleAttr.spuSaleAttrValueList)">{{value.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
